...
const chineseStandardHeightFemale = {
    0: { min: 45.0, avg: 50.0, max: 55.0 },
    1: { min: 47.0, avg: 52.0, max: 57.0 },
    2: { min: 50.0, avg: 55.0, max: 60.0 },
    3: { min: 55.0, avg: 60.6, max: 66.2 },
    4: { min: 57.0, avg: 62.5, max: 68.0 },
    5: { min: 59.0, avg: 64.5, max: 70.0 },
    6: { min: 61.0, avg: 66.8, max: 72.6 },
    7: { min: 62.5, avg: 68.5, max: 74.5 },
    8: { min: 64.0, avg: 70.0, max: 76.0 },
    9: { min: 65.5, avg: 71.5, max: 77.5 },
    10: { min: 67.0, avg: 73.0, max: 79.0 },
    11: { min: 68.5, avg: 74.5, max: 80.5 },
    12: { min: 70.0, avg: 75.0, max: 82.0 },
    13: { min: 71.5, avg: 76.5, max: 83.5 },
    14: { min: 73.0, avg: 78.0, max: 85.0 },
    15: { min: 74.5, avg: 79.5, max: 86.5 },
    16: { min: 76.0, avg: 81.0, max: 88.0 },
    17: { min: 77.5, avg: 82.5, max: 89.5 },
    18: { min: 79.0, avg: 84.0, max: 91.0 },
    19: { min: 80.5, avg: 85.5, max: 92.5 },
    20: { min: 82.0, avg: 87.0, max: 94.0 },
    21: { min: 83.5, avg: 88.5, max: 95.5 },
    22: { min: 85.0, avg: 90.0, max: 97.0 },
    23: { min: 86.5, avg: 91.5, max: 98.5 },
    24: { min: 82.0, avg: 87.2, max: 92.4 },
    25: { min: 83.5, avg: 88.7, max: 93.9 },
    26: { min: 85.0, avg: 90.2, max: 95.4 },
    27: { min: 86.5, avg: 91.7, max: 96.9 },
    28: { min: 88.0, avg: 93.2, max: 98.4 },
    29: { min: 89.5, avg: 94.7, max: 99.9 },
    30: { min: 91.0, avg: 96.2, max: 101.4 },
    31: { min: 92.5, avg: 97.7, max: 102.9 },
    32: { min: 94.0, avg: 99.2, max: 104.4 },
    33: { min: 95.5, avg: 100.7, max: 105.9 },
    34: { min: 97.0, avg: 102.2, max: 107.4 },
    35: { min: 98.5, avg: 103.7, max: 108.9 },
    36: { min: 90.0, avg: 96.3, max: 102.6 },
    37: { min: 91.5, avg: 97.8, max: 104.1 },
    38: { min: 93.0, avg: 99.3, max: 105.6 },
    39: { min: 94.5, avg: 100.8, max: 107.1 },
    40: { min: 96.0, avg: 102.3, max: 108.6 },
    41: { min: 97.5, avg: 103.8, max: 110.1 },
    42: { min: 99.0, avg: 105.3, max: 111.6 },
    43: { min: 100.5, avg: 106.8, max: 113.1 },
    44: { min: 102.0, avg: 108.3, max: 114.6 },
    45: { min: 103.5, avg: 109.8, max: 116.1 },
    46: { min: 105.0, avg: 111.3, max: 117.6 },
    47: { min: 106.5, avg: 112.8, max: 119.1 },
    48: { min: 96.0, avg: 103.1, max: 110.2 },
    49: { min: 97.5, avg: 104.6, max: 111.7 },
    50: { min: 99.0, avg: 106.1, max: 113.2 },
    51: { min: 100.5, avg: 107.6, max: 114.7 },
    52: { min: 102.0, avg: 109.1, max: 116.2 },
    53: { min: 103.5, avg: 110.6, max: 117.7 },
    54: { min: 105.0, avg: 112.1, max: 119.2 },
    55: { min: 106.5, avg: 113.6, max: 120.7 },
    56: { min: 108.0, avg: 115.1, max: 122.2 },
    57: { min: 109.5, avg: 116.6, max: 123.7 },
    58: { min: 111.0, avg: 118.1, max: 125.2 },
    59: { min: 112.5, avg: 119.6, max: 126.7 },
    60: { min: 109.0, avg: 116.6, max: 124.2 },
...
const chineseStandardHeightMale = {
    0: { min: 46.0, avg: 50.5, max: 55.0 },
    1: { min: 48.0, avg: 52.5, max: 57.0 },
    2: { min: 51.0, avg: 56.0, max: 61.0 },
    3: { min: 56.0, avg: 62.0, max: 68.0 },
    4: { min: 58.0, avg: 64.0, max: 70.0 },
    5: { min: 60.0, avg: 66.0, max: 72.0 },
    6: { min: 62.0, avg: 68.4, max: 74.8 },
    7: { min: 64.0, avg: 70.5, max: 77.0 },
    8: { min: 66.0, avg: 72.5, max: 79.0 },
    9: { min: 68.0, avg: 74.5, max: 81.0 },
    10: { min: 70.0, avg: 76.5, max: 83.0 },
    11: { min: 72.0, avg: 78.5, max: 85.0 },
    12: { min: 74.0, avg: 76.5, max: 87.0 },
    13: { min: 76.0, avg: 78.0, max: 88.5 },
    14: { min: 77.5, avg: 79.5, max: 90.0 },
    15: { min: 79.0, avg: 81.0, max: 91.5 },
    16: { min: 80.5, avg: 82.5, max: 93.0 },
    17: { min: 82.0, avg: 84.0, max: 94.5 },
    18: { min: 83.5, avg: 85.5, max: 96.0 },
    19: { min: 85.0, avg: 87.0, max: 97.5 },
    20: { min: 86.5, avg: 88.5, max: 99.0 },
    21: { min: 88.0, avg: 90.0, max: 100.5 },
    22: { min: 89.5, avg: 91.5, max: 102.0 },
    23: { min: 91.0, avg: 93.0, max: 103.5 },
    24: { min: 84.0, avg: 88.5, max: 93.0 },
    25: { min: 85.5, avg: 90.0, max: 94.5 },
    26: { min: 87.0, avg: 91.5, max: 96.0 },
    27: { min: 88.5, avg: 93.0, max: 97.5 },
    28: { min: 90.0, avg: 94.5, max: 99.0 },
    29: { min: 91.5, avg: 96.0, max: 100.5 },
    30: { min: 93.0, avg: 97.5, max: 102.0 },
    31: { min: 94.5, avg: 99.0, max: 103.5 },
    32: { min: 96.0, avg: 100.5, max: 105.0 },
    33: { min: 97.5, avg: 102.0, max: 106.5 },
    34: { min: 99.0, avg: 103.5, max: 108.0 },
    35: { min: 100.5, avg: 105.0, max: 109.5 },
    36: { min: 92.0, avg: 97.5, max: 103.0 },
    37: { min: 93.5, avg: 99.0, max: 104.5 },
    38: { min: 95.0, avg: 100.5, max: 106.0 },
    39: { min: 96.5, avg: 102.0, max: 107.5 },
    40: { min: 98.0, avg: 103.5, max: 109.0 },
    41: { min: 99.5, avg: 105.0, max: 110.5 },
    42: { min: 101.0, avg: 106.5, max: 112.0 },
    43: { min: 102.5, avg: 108.0, max: 113.5 },
    44: { min: 104.0, avg: 109.5, max: 115.0 },
    45: { min: 105.5, avg: 111.0, max: 116.5 },
    46: { min: 107.0, avg: 112.5, max: 118.0 },
    47: { min: 108.5, avg: 114.0, max: 119.5 },
    48: { min: 98.0, avg: 104.1, max: 110.2 },
    49: { min: 99.5, avg: 105.6, max: 111.7 },
    50: { min: 101.0, avg: 107.1, max: 113.2 },
    51: { min: 102.5, avg: 108.6, max: 114.7 },
    52: { min: 104.0, avg: 110.1, max: 116.2 },
    53: { min: 105.5, avg: 111.6, max: 117.7 },
    54: { min: 107.0, avg: 113.1, max: 119.2 },
    55: { min: 108.5, avg: 114.6, max: 120.7 },
    56: { min: 110.0, avg: 116.1, max: 122.2 },
    57: { min: 111.5, avg: 117.6, max: 123.7 },
...
function drawChart() {
    ...
    for (let age = minAge; age <= maxAge; age++) {
        ...
        const months = age % 12;
        if (years > 0) {
            labels.push(`${years}岁${months}月`);
        } else {
            labels.push(`${months}月`);
        }
        if (dataMap.has(age)) {
